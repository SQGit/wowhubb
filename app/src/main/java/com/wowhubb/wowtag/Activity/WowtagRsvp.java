...
public class WowtagRsvp extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wowtag_rsvp);
        ...
        user_wowtagid=findViewById(R.id.user_wowtagid);
        pro_img=findViewById(R.id.pro_img);
        event_name=findViewById(R.id.event_name);
        btn_rsvp=findViewById(R.id.btn_rsvp);
        wowtag_video=findViewById(R.id.wowtag_video);
        img_back=findViewById(R.id.img_back);
        wowtag_event_time=findViewById(R.id.wowtag_event_time);
        wowtag_date=findViewById(R.id.wowtag_date);
        eventvenue=findViewById(R.id.eventvenue);
        address=findViewById(R.id.address);
        wowtag_calendar=findViewById(R.id.wowtag_calendar);
        viewmore=findViewById(R.id.viewmore);
        lnr_wowtag_reminder=findViewById(R.id.lnr_wowtag_reminder);
        ...
        btn_rsvp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.rsvp_attending_person);
                ...
                persons_spn=v1.findViewById(R.id.persons_spn);
                til_spinpersons=v1.findViewById(R.id.til_spinpersons);
                head=v1.findViewById(R.id.head);
                msg=v1.findViewById(R.id.msg);
                register=v1.findViewById(R.id.register);
            ...
            if (jsonstr.equals("")) {
                ...
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        {
                            Log.e("tag","NULL");
                            wowtag_video.setPreviewImage(R.drawable.no_video);
