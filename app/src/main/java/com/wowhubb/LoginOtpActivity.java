...
public class LoginOtpActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       /* FontsManager.initFormAssets(LoginOtpActivity.this, "fonts/lato.ttf");
        FontsManager.changeFonts(LoginOtpActivity.this);*/
