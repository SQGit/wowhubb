...
import vineture.wowhubb.EventServiceProvider.Activity.ViewBusinessPage;
import vineture.wowhubb.EventServiceProvider.Fragment.MapDialogFragment;
...
public class EventListDetailsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        myHolder.txt_open_time.setText(current.shopOpenTime);
        ...
        myHolder.discounr.setText(current.shopDiscount);
        ...
        myHolder.viewbusinessgroup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              Intent tab=new Intent(context, ViewBusinessPage.class);
              context.startActivity(tab);
            }
        });
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public  TextView txt_shop_name,txt_shop_category,txt_shop_rating,txt_shop_address,txt_shop_mobile,txt_shop_link,txt_open_time,txt_wowsome,txt_call,viewbusinessgroup,discounr;
        ...
        public MyHolder(final View itemView) {
            ...
            viewbusinessgroup=itemView.findViewById(R.id.viewbusinessgroup);
            show_ratingbar=itemView.findViewById(R.id.show_ratingbar);
            discounr=itemView.findViewById(R.id.discounr);
            ...
            viewbusinessgroup.setTypeface(tf);
            discounr.setTypeface(tf);
        }
    }
}
