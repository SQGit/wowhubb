...
import vineture.wowhubb.EventServiceProvider.Activity.EventListDetailsNewActivity;
...
public class EventServiceProviderAdapter extends RecyclerView.Adapter<EventServiceProviderAdapter.MyViewHolder> implements Filterable {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            provider_name = view.findViewById(vineture.wowhubb.R.id.txt_provider);
            img_provider_logo = view.findViewById(vineture.wowhubb.R.id.img_provider_logo);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(vineture.wowhubb.R.layout.event_service_adapter, parent, false);
