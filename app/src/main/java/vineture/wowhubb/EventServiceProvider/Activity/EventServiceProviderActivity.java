...
import vineture.wowhubb.EventServiceProvider.Adapter.EventServiceProviderAdapter;
import vineture.wowhubb.EventServiceProvider.Model.EventServiceProviderModel;
import vineture.wowhubb.EventServiceProvider.MyDividerItemDecoration;
...
public class EventServiceProviderActivity extends AppCompatActivity implements EventServiceProviderAdapter.EventServiceAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(vineture.wowhubb.R.layout.activity_event_service_provider);
        Toolbar toolbar = findViewById(vineture.wowhubb.R.id.toolbar);
        setSupportActionBar(toolbar);

        // toolbar fancy stuff
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle(vineture.wowhubb.R.string.event_service);
        ...
        av_loader = findViewById(vineture.wowhubb.R.id.avi);

        recyclerView = findViewById(vineture.wowhubb.R.id.recycler_view);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(vineture.wowhubb.R.menu.menu_main, menu);

        // Associate searchable configuration with the SearchView
        SearchManager searchManager = (SearchManager) getSystemService(Context.SEARCH_SERVICE);
        searchView = (SearchView) menu.findItem(vineture.wowhubb.R.id.action_search)
                .getActionView();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == vineture.wowhubb.R.id.action_search) {
            return true;
        }
