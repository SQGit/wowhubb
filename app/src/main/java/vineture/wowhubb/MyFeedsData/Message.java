...
public class Message {
    ...
    public Integer getEventtypeint() {
        return eventtypeint;
    }
    ...
    public Object getEventspeakeractivities2() {
    ...
    public Object getEventspeakerlink2() {
    ...
    public Object getEventguesttype2() {
    ...
    public Object getEventguesttype1() {
    ...
    public Integer getEventdayscount() {
    ...
    public String getTeleconferencepassword() {
        return teleconferencepassword;
    }

    public void setTeleconferencepassword(String teleconferencepassword) {
        this.teleconferencepassword = teleconferencepassword;
    }

    public String getTeleconferencephone() {
        return teleconferencephone;
    }

    public void setTeleconferencephone(String teleconferencephone) {
        this.teleconferencephone = teleconferencephone;
    }
    ...
    public String getOnlineeventname() {
        return onlineeventname;
    }

    public void setOnlineeventname(String onlineeventname) {
        this.onlineeventname = onlineeventname;
    }
