...
import vineture.wowhubb.Nearbyeventsmodule.Activity.PlayVideoActivity;
import vineture.wowhubb.Nearbyeventsmodule.Fragment.InfoEventFragment;
import vineture.wowhubb.Nearbyeventsmodule.Fragment.ScheduleEventFragment;
...
public class NearbyEventIndividualPage extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(vineture.wowhubb.R.layout.nearby_event_individual_page);
        ...
        lnr_wowtag=findViewById(vineture.wowhubb.R.id.lnr_wowtag);
