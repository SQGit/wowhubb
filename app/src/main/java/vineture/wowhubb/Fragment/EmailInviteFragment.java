...
public class EmailInviteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(vineture.wowhubb.R.layout.emailinvitefragment, container, false);
        ...
        mChipsView = (ChipsView) view.findViewById(vineture.wowhubb.R.id.cv_contacts);
        ...
        sendemail_tv = view.findViewById(vineture.wowhubb.R.id.sendemail_tv);
