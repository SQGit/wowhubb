...
public class ReligionandHelalthEventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(vineture.wowhubb.R.layout.activity_relegionandhealthevent,
                container, false);
        ...
        cse_cb = (CheckBox) view.findViewById(vineture.wowhubb.R.id.religion_cb);
        hobbies_cb = (CheckBox) view.findViewById(vineture.wowhubb.R.id.food_cb);
        parties_cb = (CheckBox) view.findViewById(vineture.wowhubb.R.id.sports_cb);
        charity_cb = (CheckBox) view.findViewById(vineture.wowhubb.R.id.charity_cb);
        family_cb = (CheckBox) view.findViewById(vineture.wowhubb.R.id.family_cb);
        witness_cb = (CheckBox) view.findViewById(vineture.wowhubb.R.id.witness_cb);
        ...
        parties_ev = (ImageView) view.findViewById(vineture.wowhubb.R.id.sports_iv);

        charity_iv = (ImageView) view.findViewById(vineture.wowhubb.R.id.charity_iv);
        femily_iv = (ImageView) view.findViewById(vineture.wowhubb.R.id.family_iv);
        witness_iv = (ImageView) view.findViewById(vineture.wowhubb.R.id.witness_iv);
        ...
        if (!charity.equals("")) {
            if (charity.equals("11")) {
                ...
                charity_iv.setBackground(getResources().getDrawable(vineture.wowhubb.R.drawable.selector_interest_color));
                charity_iv.setColorFilter(charity_iv.getContext().getResources().getColor(vineture.wowhubb.R.color.white), PorterDuff.Mode.SRC_ATOP);
            }
        ...
        if (!family.equals("")) {
            if (family.equals("12")) {
                ...
                femily_iv.setBackground(getResources().getDrawable(vineture.wowhubb.R.drawable.selector_interest_color));
                femily_iv.setColorFilter(femily_iv.getContext().getResources().getColor(vineture.wowhubb.R.color.white), PorterDuff.Mode.SRC_ATOP);
            }
        ...
        if (!wellness.equals("")) {
            if (wellness.equals("14")) {
                ...
                witness_iv.setBackground(getResources().getDrawable(vineture.wowhubb.R.drawable.selector_interest_color));
                witness_iv.setColorFilter(witness_iv.getContext().getResources().getColor(vineture.wowhubb.R.color.white), PorterDuff.Mode.SRC_ATOP);
            }
        ...
        charity_iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag4 == true) {
                    ...
                    edit.commit();
                    charity_iv.setBackground(getResources().getDrawable(vineture.wowhubb.R.drawable.selector_interest));
                    charity_iv.setColorFilter(charity_iv.getContext().getResources().getColor(vineture.wowhubb.R.color.colorPrimary), PorterDuff.Mode.SRC_ATOP);
                }
        ...
        femily_iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag5 == true) {
                    ...
                    edit.commit();
                    femily_iv.setBackground(getResources().getDrawable(vineture.wowhubb.R.drawable.selector_interest));
                    femily_iv.setColorFilter(femily_iv.getContext().getResources().getColor(vineture.wowhubb.R.color.colorPrimary), PorterDuff.Mode.SRC_ATOP);
                }
        ...
        witness_iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag6 == true) {
                    ...
                    edit.commit();
                    witness_iv.setBackground(getResources().getDrawable(vineture.wowhubb.R.drawable.selector_interest));
                    witness_iv.setColorFilter(witness_iv.getContext().getResources().getColor(vineture.wowhubb.R.color.colorPrimary), PorterDuff.Mode.SRC_ATOP);
                }
