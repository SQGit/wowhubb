...
import vineture.wowhubb.Adapter.Schedule;
...
public class ProgramScheduleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(vineture.wowhubb.R.layout.fragment_programschedule_list, container, false);
        ...
        recyclerView = (ListView) view.findViewById(vineture.wowhubb.R.id.listview);
        addmore = (ImageView) view.findViewById(vineture.wowhubb.R.id.addmore_tv);
        lv1 = view.findViewById(vineture.wowhubb.R.id.lv1);
        lv2 = view.findViewById(vineture.wowhubb.R.id.lv2);
        lv3 = view.findViewById(vineture.wowhubb.R.id.lv3);
        lv4 = view.findViewById(vineture.wowhubb.R.id.lv4);
        day1 = view.findViewById(vineture.wowhubb.R.id.day1_tv);
        day2 = view.findViewById(vineture.wowhubb.R.id.day2_tv);
        day3 = view.findViewById(vineture.wowhubb.R.id.day3_tv);
        day4 = view.findViewById(vineture.wowhubb.R.id.day4_tv);
    ...
    public class ScheduleAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(vineture.wowhubb.R.layout.fragment_programschedule, parent, false);
                FontsOverride.overrideFonts(getActivity(), convertView);

                holder = new ViewHolder();
                holder.mWatcher = new MutableWatcher();
                holder.fromtime_tv = (EditText) convertView.findViewById(vineture.wowhubb.R.id.fromtv);
                holder.totime_tv = (EditText) convertView.findViewById(vineture.wowhubb.R.id.totv);
                holder.fromlv = (LinearLayout) convertView.findViewById(vineture.wowhubb.R.id.fromlv);
                holder.tolv = (LinearLayout) convertView.findViewById(vineture.wowhubb.R.id.tolv);
                holder.layout_fromdate = convertView.findViewById(vineture.wowhubb.R.id.layout_fromdate);
                holder.layout_todate = convertView.findViewById(vineture.wowhubb.R.id.layout_todate);
            ...
            dialog.setContentView(vineture.wowhubb.R.layout.dialog_getdirection);
            final LinearLayout newvenue = dialog.findViewById(vineture.wowhubb.R.id.newvenue_lv);
            final CheckBox newvenue_cb = dialog.findViewById(vineture.wowhubb.R.id.newvenue_cb);
            final CheckBox samevenue_cb = dialog.findViewById(vineture.wowhubb.R.id.samevenue_id);
            final ImageView sub = dialog.findViewById(vineture.wowhubb.R.id.submit_iv);

            final ImageView close = dialog.findViewById(vineture.wowhubb.R.id.closeiv);
