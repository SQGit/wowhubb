...
import vineture.wowhubb.Fragment.ContactChip;
...
public class CreateGroupActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FontsOverride.overrideFonts(CreateGroupActivity.this, v1);
        ...
        final SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(CreateGroupActivity.this);
        ...
        final CustomAdapter eventdayAdapter = new CustomAdapter(CreateGroupActivity.this, android.R.layout.simple_dropdown_item_1line, PRIVACYLIST) {
            @Override
       ...
       // privacy_til.setTypeface(lato);
        ...
        privacy_spn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                FontsOverride.overrideFonts(CreateGroupActivity.this, view);
    ...
    public class createGroup extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
                startActivity(new Intent(CreateGroupActivity.this, CreateGroup.class));
