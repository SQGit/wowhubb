...
public class QuickCreateEvent extends Activity {
    ...
    LinearLayout fromlv, tolv, layout_fromtime, layout_totime, layout_runfromdate, layout_runtodate, backiv, lnr_gallery, lnr_video;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(vineture.wowhubb.R.layout.create_quickevent);
        ...
        eventdate_et = findViewById(vineture.wowhubb.R.id.eventdate);
        eventdesc_et = findViewById(vineture.wowhubb.R.id.eventdesc_et);
        eventdateto_et = findViewById(vineture.wowhubb.R.id.eventdateto_et);
        eventtopic_til = findViewById(vineture.wowhubb.R.id.til_eventtopic);
        eventdate_til = findViewById(vineture.wowhubb.R.id.til_eventdate);
        eventdateto_til = findViewById(vineture.wowhubb.R.id.til_eventdateto);
        eventaddcategory_til = findViewById(vineture.wowhubb.R.id.til_eventaddcategory);
        eventtimezone_til = findViewById(vineture.wowhubb.R.id.til_eventtimezone);
        helpfultips_tv = findViewById(vineture.wowhubb.R.id.helpfultips_tv);
        til_spincategory = findViewById(vineture.wowhubb.R.id.til_spincategory);

        til_desc = findViewById(vineture.wowhubb.R.id.til_eventdesc);
        scrollView = findViewById(vineture.wowhubb.R.id.scrollView);

        fromlv = findViewById(vineture.wowhubb.R.id.fromlv);
        tolv = findViewById(vineture.wowhubb.R.id.tolv);
        eventstarttime = findViewById(vineture.wowhubb.R.id.eventstarttime);
        eventendtime = findViewById(vineture.wowhubb.R.id.eventendtime);
        runfromtime_tv = findViewById(vineture.wowhubb.R.id.runfromtv);
        runtotime_tv = findViewById(vineture.wowhubb.R.id.runtotv);
        til_from = findViewById(vineture.wowhubb.R.id.til_from);
        til_to = findViewById(vineture.wowhubb.R.id.til_to);
        til_eventtime = findViewById(vineture.wowhubb.R.id.til_eventtime);
        til_eventtimeto = findViewById(vineture.wowhubb.R.id.til_eventtimeto);
        layout_runfromdate = findViewById(vineture.wowhubb.R.id.layout_runfromdate);
        layout_runtodate = findViewById(vineture.wowhubb.R.id.runlayout_todate);
        framevideo1 = findViewById(vineture.wowhubb.R.id.framevideo1);
        tickiv = findViewById(vineture.wowhubb.R.id.tickiv);
        eventname_et = findViewById(vineture.wowhubb.R.id.eventtitle_et);
        video0_iv = findViewById(vineture.wowhubb.R.id.video0_iv);
        video1plus = findViewById(vineture.wowhubb.R.id.video1plus_iv);
        publishtv = findViewById(vineture.wowhubb.R.id.publishtv);
        wowtagfrom = Calendar.getInstance();
        onlineevent_cb = findViewById(vineture.wowhubb.R.id.onlineevent_cb);
        eventtopic_et = findViewById(vineture.wowhubb.R.id.eventtopic_et);
        layout_eventdate = findViewById(vineture.wowhubb.R.id.layout_eventdate);
        layout_eventdateto = findViewById(vineture.wowhubb.R.id.layout_todate);
        layout_totime = findViewById(vineture.wowhubb.R.id.layout_totime);
        layout_fromtime = findViewById(vineture.wowhubb.R.id.layout_eventtime);

        eventaddcategory_et = findViewById(vineture.wowhubb.R.id.eventaddcategory_et);
        eventtimezone_et = findViewById(vineture.wowhubb.R.id.eventtimezone_et);
        nextlv = findViewById(vineture.wowhubb.R.id.nextlv);
        framestart = findViewById(vineture.wowhubb.R.id.frame_startdate);
        backiv = findViewById(vineture.wowhubb.R.id.back_lv);
        ...
        onlineevent_cb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    comments_dialog.setContentView(vineture.wowhubb.R.layout.dialog_onlineevent);
                    ...
                    final LinearLayout webinarlv = comments_dialog.findViewById(vineture.wowhubb.R.id.webinar_lv);
                    final LinearLayout telelv = comments_dialog.findViewById(vineture.wowhubb.R.id.tele_lv);
                    TextView submittv = comments_dialog.findViewById(vineture.wowhubb.R.id.submittv);
                    webinarlink_et = comments_dialog.findViewById(vineture.wowhubb.R.id.webinarlink_et);
                    telephone_et = comments_dialog.findViewById(vineture.wowhubb.R.id.teleconphone_et);
                    telepasscode_et = comments_dialog.findViewById(vineture.wowhubb.R.id.passcode_et);
                    ...
                    til_event_spn = comments_dialog.findViewById(vineture.wowhubb.R.id.til_spnevents);
                    TextInputLayout til_webinar_link = comments_dialog.findViewById(vineture.wowhubb.R.id.til_webinar_link);
                    TextInputLayout til_telecon_phone = comments_dialog.findViewById(vineture.wowhubb.R.id.til_telecon_phone);
                    TextInputLayout til_passcode = comments_dialog.findViewById(vineture.wowhubb.R.id.til_passcode);
                    event_spn = comments_dialog.findViewById(vineture.wowhubb.R.id.category_spn);
...
*/
        ...
        framevideo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog = new Dialog(QuickCreateEvent.this);
                dialog.setContentView(vineture.wowhubb.R.layout.dialog_takevideo);
                dialog.setOnShowListener(new DialogInterface.OnShowListener() {
                    @Override
                    public void onShow(DialogInterface dialogInterface) {
                        Window view1 = dialog.getWindow();
                        view1.setBackgroundDrawableResource(vineture.wowhubb.R.drawable.border_bg);
                    }
                });
                txt_fromgallery = dialog.findViewById(vineture.wowhubb.R.id.txt_fromgallery);
                //img_take_gallery = (ImageView) dialog.findViewById(R.id.img_take_gallery);
                txt_takevideo = dialog.findViewById(vineture.wowhubb.R.id.txt_takevideo);
                //img_take_video = (ImageView) dialog.findViewById(R.id.img_take_video);
                ImageView image = dialog.findViewById(vineture.wowhubb.R.id.imageDialog);
                lnr_video = dialog.findViewById(vineture.wowhubb.R.id.lnr_video);
                lnr_gallery = dialog.findViewById(vineture.wowhubb.R.id.lnr_gallery);
                ...
                lnr_gallery.setBackgroundResource(vineture.wowhubb.R.drawable.btn_bg_white);
                lnr_video.setBackgroundResource(vineture.wowhubb.R.drawable.btn_bg_white);
                ...
                lnr_gallery.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dialog.dismiss();
                        lnr_gallery.setBackgroundResource(vineture.wowhubb.R.drawable.btnbg);
                ...
                lnr_video.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                            ...
                            lnr_video.setBackgroundResource(vineture.wowhubb.R.drawable.btnbg);
        ...
        layout_runfromdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!eventdate_et.getText().toString().trim().equalsIgnoreCase("")) {
                    ...
                    final DatePicker dp = cdialog.findViewById(vineture.wowhubb.R.id.datePicker);
                    TextView ok = cdialog.findViewById(vineture.wowhubb.R.id.oktv);
                    TextView cancel = cdialog.findViewById(vineture.wowhubb.R.id.canceltv);
                    //  dp.setMinDate(System.currentTimeMillis() - 1000);
        ...
        MaterialBetterSpinner materialDesignSpinner = findViewById(vineture.wowhubb.R.id.category_spn);
    ...
    private void populateSetTime(int hourOfDay, int minute) {
        ...
        if (hourOfDay >= 0 && hourOfDay < 12) {
            am_pm = strDateFormat + "AM";
        } else {
            if (hourOfDay == 12) {
                am_pm = strDateFormat + "PM";
            } else {
                hourOfDay = hourOfDay - 12;
                strDateFormat = String.format("%02d:%02d", hourOfDay, minute);
                if (hourOfDay < 12)
            ...
            if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                try {
                    ...
                    if ((duration / 1000) > 30) {
                        ...
                        video0_iv.setImageDrawable(QuickCreateEvent.this.getDrawable(vineture.wowhubb.R.drawable.dotted_square));
                        video1plus.setImageDrawable(QuickCreateEvent.this.getDrawable(vineture.wowhubb.R.drawable.plus_icon));
                        ...
                        try {
                            ...
                            video1plus.setImageDrawable(QuickCreateEvent.this.getDrawable(vineture.wowhubb.R.drawable.video_icon));
    ...
    private boolean checkPermission() {
        ...
        int result2 = ContextCompat.checkSelfPermission(QuickCreateEvent.this, Manifest.permission.CAMERA);
        if ((result == PackageManager.PERMISSION_GRANTED) && (result1 == PackageManager.PERMISSION_GRANTED) && (result2 == PackageManager.PERMISSION_GRANTED)) {
            return true;
        } else {
            ActivityCompat.requestPermissions(QuickCreateEvent.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, android.Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, 1);
            return false;
        ...
        switch (requestCode) {
            ...
            case 1:
                if (grantResults.length > 0) {
                    ...
                    if (ReadStoragePermission && CameraPermission && WriteStoragePermission) {
                        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                            Log.e("tag", "111111------->>>>>>>>>NOUGAT");
                            Intent intent = new Intent(MediaStore.ACTION_VIDEO_CAPTURE);
                            videoUri = getOutputMediaFileUri2(MEDIA_TYPE_VIDEO);
                        ...
                        Toast.makeText(QuickCreateEvent.this, "Permission Denied", Toast.LENGTH_LONG).show();
                    }
                }
