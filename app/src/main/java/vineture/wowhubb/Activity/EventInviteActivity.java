...
import vineture.wowhubb.Fragment.EmailInviteFragment;
import vineture.wowhubb.Fragment.SmsInviteFragment;
...

{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(vineture.wowhubb.R.layout.eventinvite);
