...
import vineture.wowhubb.Adapter.TodayEventsAdapter;
...
public class TodayEventActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(vineture.wowhubb.R.layout.dialog_todayevents);

        View v1 = getWindow().getDecorView().getRootView();
        FontsOverride.overrideFonts(TodayEventActivity.this, v1);
        gridView = findViewById(vineture.wowhubb.R.id.gridlayout);
        closeiv=findViewById(vineture.wowhubb.R.id.closeiv);
