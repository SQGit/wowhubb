...
import vineture.wowhubb.Fragment.CreateGroupFragment;
import vineture.wowhubb.Fragment.DiscoverGroupFragment;
import vineture.wowhubb.Fragment.EventGroupFragment;
...
public class CreateGroup extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(vineture.wowhubb.R.layout.create_group);
        ...
        backiv = findViewById(vineture.wowhubb.R.id.backtv);
        createfab = findViewById(vineture.wowhubb.R.id.createfab);
    ...
    private void setupTabIcons() {
        ...
        TextView tabThree = (TextView) LayoutInflater.from(this).inflate(vineture.wowhubb.R.layout.customtabgroup_title, null);
        ...
        tabLayout.setTabTextColors(
                getResources().getColor(vineture.wowhubb.R.color.textcolr),
                getResources().getColor(vineture.wowhubb.R.color.white)
        );
