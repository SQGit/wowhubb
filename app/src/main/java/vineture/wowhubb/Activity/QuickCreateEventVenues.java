...
public class QuickCreateEventVenues extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(vineture.wowhubb.R.layout.create_quickvenue);
        ...
        phone_et = findViewById(vineture.wowhubb.R.id.phone_et);
        email_et = findViewById(vineture.wowhubb.R.id.email_et);
        previouslv = findViewById(vineture.wowhubb.R.id.previouslv);
        lato = Typeface.createFromAsset(getAssets(), "fonts/lato.ttf");
        registerrsvp_cb = findViewById(vineture.wowhubb.R.id.registerrsvp_cb);
        inviteonlyevent_cb = findViewById(vineture.wowhubb.R.id.invitedonly_event);
        til_eventname = (TextInputLayout) findViewById(vineture.wowhubb.R.id.til_eventvenue);
        till_address = (TextInputLayout) findViewById(vineture.wowhubb.R.id.til_address);
        till_city = (TextInputLayout) findViewById(vineture.wowhubb.R.id.til_city);
        till_state = (TextInputLayout) findViewById(vineture.wowhubb.R.id.til_state);
        til_zipcode = (TextInputLayout) findViewById(vineture.wowhubb.R.id.til_zipcode);
        til_name = (TextInputLayout) findViewById(vineture.wowhubb.R.id.til_name);
        til_phone = (TextInputLayout) findViewById(vineture.wowhubb.R.id.til_phone);
        til_email = (TextInputLayout) findViewById(vineture.wowhubb.R.id.til_email);
        til_msg = (TextInputLayout) findViewById(vineture.wowhubb.R.id.til_msg);
        eventvenue_lv = findViewById(vineture.wowhubb.R.id.eventvenue_lv);
        publishgroup_gp = findViewById(vineture.wowhubb.R.id.group_rb);


        publishtv = findViewById(vineture.wowhubb.R.id.publishtv);
        eventvenue_et = findViewById(vineture.wowhubb.R.id.eventvenue_et);
        address_et = findViewById(vineture.wowhubb.R.id.address_et);
        city_et = findViewById(vineture.wowhubb.R.id.city_et);
        state_et = findViewById(vineture.wowhubb.R.id.state_et);
        zipcode_et = findViewById(vineture.wowhubb.R.id.zipcode_et);
        final com.suke.widget.SwitchButton phone_sb = (com.suke.widget.SwitchButton)
                findViewById(vineture.wowhubb.R.id.switch_button);
        com.suke.widget.SwitchButton mail_sb = (com.suke.widget.SwitchButton)
                findViewById(vineture.wowhubb.R.id.switch_button1);
        ...
        dialog.setContentView(vineture.wowhubb.R.layout.dialog_wowhubb_networklist);


        ImageView closeiv = dialog.findViewById(vineture.wowhubb.R.id.closeiv);
        grouppublishtv = (TextView) dialog.findViewById(vineture.wowhubb.R.id.publish_tv);
    ...
    public void onRadioButtonClicked(View v) {
        specificgroup_rb = findViewById(vineture.wowhubb.R.id.specificgroup_rb);
        sharenetwork_rb = findViewById(vineture.wowhubb.R.id.invitedguest_cb);
        ...
        switch (v.getId()) {
            ...
            case vineture.wowhubb.R.id.specificgroup_rb:
                if (checked)
                    dialog.show();
                else
                    dialog.dismiss();
            ...
            case vineture.wowhubb.R.id.invitedguest_cb:
            ...
            if (s != null) {
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        askinvite_dialog.setContentView(vineture.wowhubb.R.layout.dilaog_sendinvites);
                        View v1 = askinvite_dialog.getWindow().getDecorView().getRootView();
                        FontsOverride.overrideFonts(QuickCreateEventVenues.this, v1);
                        ImageView close = askinvite_dialog.findViewById(vineture.wowhubb.R.id.closeiv);
                        TextView tvinvite = (TextView) askinvite_dialog.findViewById(vineture.wowhubb.R.id.invitetv);
                        TextView tvskip = (TextView) askinvite_dialog.findViewById(vineture.wowhubb.R.id.tvskip);
