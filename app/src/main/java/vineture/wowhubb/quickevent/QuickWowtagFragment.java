...
public class QuickWowtagFragment extends Fragment {
    ...
    public static QuickWowtagFragment newInstance(int page, boolean isLast) {
        Bundle args = new Bundle();
        args.putInt("page", page);
        if (isLast)
            args.putBoolean("isLast", true);
        final QuickWowtagFragment fragment = new QuickWowtagFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(vineture.wowhubb.R.layout.activity_wowtag, container, false);
        ...
        fromtime_tv = (TextView) view.findViewById(vineture.wowhubb.R.id.fromtv);
        totime_tv = (TextView) view.findViewById(vineture.wowhubb.R.id.totv);
        fromlv = (LinearLayout) view.findViewById(vineture.wowhubb.R.id.fromlv);
        tolv = (LinearLayout) view.findViewById(vineture.wowhubb.R.id.tolv);
        layout_fromdate = view.findViewById(vineture.wowhubb.R.id.layout_fromdate);
        layout_todate = view.findViewById(vineture.wowhubb.R.id.layout_todate);
        tickiv = view.findViewById(vineture.wowhubb.R.id.tickiv);
        eventname_et = view.findViewById(vineture.wowhubb.R.id.eventtitle_et);
        eventname_et.setText(eventData.eventttitle);
        video0_iv = (ImageView) view.findViewById(vineture.wowhubb.R.id.video0_iv);
        video1plus = view.findViewById(vineture.wowhubb.R.id.video1plus_iv);
        ...
        try {
            if (eventData.eventwowvideo != "") {
                ...
                video1plus.setImageDrawable(getActivity().getDrawable(vineture.wowhubb.R.drawable.video_icon));
            } else if (eventData.eventwowvideo == null) {
                Log.e("tag", "22222222222-dddd------" + eventData.eventwowvideo);
                video0_iv.setImageResource(vineture.wowhubb.R.drawable.dotted_square);
                video1plus.setImageDrawable(getActivity().getDrawable(vineture.wowhubb.R.drawable.video_icon));
            }
        ...
        til_from = (TextInputLayout) view.findViewById(vineture.wowhubb.R.id.til_from);
        til_to = (TextInputLayout) view.findViewById(vineture.wowhubb.R.id.til_to);
        ...
        framevideo1 = view.findViewById(vineture.wowhubb.R.id.framevideo1);
        ...
        framevideo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txt_fromgallery = (TextView) dialog.findViewById(vineture.wowhubb.R.id.txt_fromgallery);
                //img_take_gallery = (ImageView) dialog.findViewById(R.id.img_take_gallery);
                txt_takevideo = (TextView) dialog.findViewById(vineture.wowhubb.R.id.txt_takevideo);
                //img_take_video = (ImageView) dialog.findViewById(R.id.img_take_video);


                ImageView image = (ImageView) dialog.findViewById(vineture.wowhubb.R.id.imageDialog);
                final LinearLayout lnr_video = (LinearLayout) dialog.findViewById(vineture.wowhubb.R.id.lnr_video);
                final LinearLayout lnr_gallery = (LinearLayout) dialog.findViewById(vineture.wowhubb.R.id.lnr_gallery);
