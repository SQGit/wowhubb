 ...
 */
public class InviteContactsRecyclerAdapter extends RecyclerView.Adapter<InviteContactsRecyclerAdapter.BeneficiaryViewHolder>
{
    ...
    public InviteContactsRecyclerAdapter(List<Contact> list, ArrayList<Contact> filterlist, Context context)
    {
    ...
    {
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_contact_itemlinvite, parent, false);
