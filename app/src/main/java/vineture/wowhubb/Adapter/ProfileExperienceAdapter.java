...
public class ProfileExperienceAdapter extends BaseAdapter {
    ...
    public ProfileExperienceAdapter(Context context, ArrayList<ProfileModel> modelList, ArrayList<String> skillList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.professionalworkexp_itemlist, null);
            ...
            locationtv.setText(m.getCompany()+" , "+m.getLocation());
