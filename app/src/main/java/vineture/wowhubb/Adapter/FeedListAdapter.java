...
import vineture.wowhubb.Activity.FeedActivityImage;
import vineture.wowhubb.Activity.FeedActivityVideo;
import vineture.wowhubb.Activity.ViewFeedActivityDetails;
import vineture.wowhubb.Fonts.FontsOverride;
import vineture.wowhubb.Utils.HttpUtils;
import vineture.wowhubb.Utils.ItemDetailsWrapper;
...
public class FeedListAdapter extends BaseAdapter {
    ...
    public FeedListAdapter(Activity activity, List<FeedItem> feedItems) {
        ...
        imageLoader1 = new ImageLoader(activity.getApplicationContext());
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(vineture.wowhubb.R.layout.feed_items_professional, null);
            ...
            viewHolder.name = (TextView) convertView.findViewById(vineture.wowhubb.R.id.hoster_name);
            viewHolder.eventname_tv = (TextView) convertView.findViewById(vineture.wowhubb.R.id.eventname_tv);
            viewHolder.timestamp = (TextView) convertView.findViewById(vineture.wowhubb.R.id.timestamp);
            viewHolder.desc = (TextView) convertView.findViewById(vineture.wowhubb.R.id.desc_tv);
            viewHolder.profilePic = (ImageView) convertView.findViewById(vineture.wowhubb.R.id.imageview_profile);
            viewHolder.feedImageView = (ImageView) convertView.findViewById(vineture.wowhubb.R.id.feedImage1);

            viewHolder.wowsome_tv = convertView.findViewById(vineture.wowhubb.R.id.wowsome_tv);
            viewHolder.comments = convertView.findViewById(vineture.wowhubb.R.id.comments_tv);
            viewHolder.share = convertView.findViewById(vineture.wowhubb.R.id.share_tv);
            viewHolder.viewmore_tv = convertView.findViewById(vineture.wowhubb.R.id.viewmore_tv);


            viewHolder.viewwowsome = convertView.findViewById(vineture.wowhubb.R.id.viewwow_tv);
            viewHolder.viewcomments = convertView.findViewById(vineture.wowhubb.R.id.viewcomments_tv);
            viewHolder.viewshare = convertView.findViewById(vineture.wowhubb.R.id.viewshare_tv);


            viewHolder.month_tv = convertView.findViewById(vineture.wowhubb.R.id.month_tv);
            viewHolder.date_tv = convertView.findViewById(vineture.wowhubb.R.id.date_tv);
            viewHolder.time_tv = convertView.findViewById(vineture.wowhubb.R.id.time_tv);

            runttime_lv = convertView.findViewById(vineture.wowhubb.R.id.runtimelv);

            viewHolder.eventtopic_tv = convertView.findViewById(vineture.wowhubb.R.id.eventtopic_tv);
            viewHolder.otherurl_tv = convertView.findViewById(vineture.wowhubb.R.id.otherurl_tv);
            viewHolder.eventaddress_tv = convertView.findViewById(vineture.wowhubb.R.id.address_tv);

            sharedPrefces = PreferenceManager.getDefaultSharedPreferences(activity);
            edit = sharedPrefces.edit();
            viewHolder.frameLayout = convertView.findViewById(vineture.wowhubb.R.id.framevideo1);

            viewHolder.highlight1_iv = convertView.findViewById(vineture.wowhubb.R.id.highlight1);
            viewHolder.highlight2_iv = convertView.findViewById(vineture.wowhubb.R.id.highlight2);
            viewHolder.video1plus = convertView.findViewById(vineture.wowhubb.R.id.video1plus_iv);
            viewHolder.video2plus = convertView.findViewById(vineture.wowhubb.R.id.video2plus_iv);
            viewHolder.video3plus = convertView.findViewById(vineture.wowhubb.R.id.video3plus_iv);
            viewHolder.wowtagvideo = convertView.findViewById(vineture.wowhubb.R.id.video0_iv);
        ...
        if (item.getProfilePic() != null) {
            ...
            viewHolder.profilePic.setImageResource(vineture.wowhubb.R.drawable.profile_img);
        }
        ...
        if (!item.getWowtagvideo().equals("null")) {
            ...
            try {
                ...
                viewHolder.video1plus.setImageDrawable(activity.getDrawable(vineture.wowhubb.R.drawable.video_icon));
        ...
        if (!item.getHighlightvideo1().equals("null")) {
            ...
            try {
                ...
                viewHolder.video2plus.setImageDrawable(activity.getDrawable(vineture.wowhubb.R.drawable.video_icon));
        ...
        if (!item.getHighlightvideo2().equals("null")) {
            ...
            try {
                ...
                viewHolder.video3plus.setImageDrawable(activity.getDrawable(vineture.wowhubb.R.drawable.video_icon));
